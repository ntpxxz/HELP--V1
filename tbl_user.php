...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-target=" #tables-nav" data-bs-toggle="collapse" href="tbl_user.php">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="column7"><a href=update_users.php?edit_user=<?php echo $row['user_id']; ?>" class="bi bi-eye"></a></td>
                                            <td class="column8"><a href=deleteuser.php?del_user=<?php echo $row['user_id']; ?>" class="btn btn-danger" onclick="return checkDelete()"><i class=" bi bi-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
