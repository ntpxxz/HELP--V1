...
<body>
    ...
    <div class="container">
        ...
        <div class="user-profile">
            ...
            $select_user = mysqli_query($connect, $sql) or die('query failed');
            ...
            <div class="flex">
                ...
                <a href="register.php" class="option-btn">register</a>_
        ...
        <div class="products">
            ...
            <div class="box-container">
                ...
                <?php
                $sql = "SELECT*FROM rith_item";
                $select_product = mysqli_query($connect, $sql) or die('query failed');

                if (mysqli_num_rows($select_product) > 0) {
                    while ($fetch_product = mysqli_fetch_assoc($select_product)) {
                ?>
                        <form method="post" class="box" action="">
                            <img src="../upload/item_img/<?php echo $fetch_product['item_img']; ?>" alt="">
                            <div class="name"><?php echo $fetch_product['item_name']; ?></div>
                            <div class="price">$<?php echo $fetch_product['item_ass']; ?>/-</div>
                            <input type="number" min="1" name="product_quantity" value="1">
                            <input type="hidden" name="product_image" value="<?php echo $fetch_product['item_img']; ?>">
                            <input type="hidden" name="product_name" value="<?php echo $fetch_product['item_name']; ?>">
                            <input type="hidden" name="product_price" value="<?php echo $fetch_product['item_ass']; ?>">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>$<?php echo $sub_total = ("50" * $fetch_cart['quantity']); ?>/-</td>
