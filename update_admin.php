...
if (isset($_POST['update'])) {
    ...
    $sql = $update_user->update_admins($user_name, $user_lastname, $user_pass, $gender, $user_sec, $user_reg, $user_address, $user_mail, $user_tel, $user_status, $user_id);
    if ($sql) {
                                    ...
                                    <div class="card-body center ">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <select id="user_status" class="form-select" name="user_status" value="">
                                                    <option selected>Choose...</option>
                                        ...
                                        <div class="row mb align-items-center justify-content-center ">
                                            ...
                                            <div class="col-4"><a href=deleteuser.php?del_user=<?php echo $row['user_id']; ?>" class="btn btn-danger w-100" onclick="return checkDelete()"><i class=" bi bi-trash"></i></a>
                                        </div>
