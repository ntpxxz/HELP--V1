...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      </li><!-- End job status Nav --><!-- End job status Nav -->
                    ...
                    <div class=" border-black">
                      <section class="case-area mt-0">
                        ...
                        <div class="row justify-content-between text-start mb-2  text-start mb-2">
                          ...
                          <div class="col-lg-4 ">
                            <b class="fw-semibold">Computer name:</b>&nbsp<?php echo $row['item_ass']; ?>
                          </div>
                          <div class="col-lg-4">
                      ...
                      <section class="case-area mt-0">
                        ...
                        <div class="row align-items-start justify-content-between text-start mb-2">
                          ...
                          <div class="col-4">
                            <span class="fw-semibold">Section:</span> <?php echo $row['user_sec']; ?>
                          </div>
                        </div>
                            ...
                            <div class="repeater-wrapper pt-0 pt-md-2" data-repeater-item="">
                              <div class="d-flex rounded position-relative pe-0">
                                <div class="col-md-12 col-12 mb-md-0 mb-2">
                                  ...
                                  <textarea class="form-control" rows="2" id="chk_re" name="chk_re"><?php echo $row['chk_re']; ?></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md- mb-md-0 mb-2">
                              <div class="repeater-wrapper d-flex align-items-center mb-2">
                                <div class="col-md-12 col-12 mb-md-0 mb-4 justify-content-start">
                                  <label for="salesperson" class="form-label me-0"><b>Resolution:</b></label>
                                  <div class="row g-3 d-flex align-items-center mb-0">
                                    <div class="col-lg-2">
                                      <label class="fw-semibold">Request to External Provider Repair:</label>
                                    </div>
                                    <div class="col-lg-6">
                                      <input type="text" class="form-control" id="re_de1" name="re_de1" placeholder="Please enter External provider" value="<?php echo $row['re_de1']; ?>">
                                    </div>
                                    <div class="col-lg-1">
                                    ...
                                    <div class="col-lg-3">
                                      <input type="date" class="form-control" id="re_date1" placeholder="Add External provider" value="<?php echo $row['re_date1']; ?>" name="re_date1">
                                    </div>
                                  </div>
                                  <div class="row g-3 d-flex align-items-center mb-0">
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-6">
                                      <input type="text" class="form-control" id="re_de2" placeholder="Please enter part details" value="<?php echo $row['re_de2']; ?>" name="re_de2">
                                    </div>
                                    <div class="col-lg-1">
                                      <label class="fw-semibold">On:</label>
                                    </div>
                                    ...
                                    <div class="col-lg-3 align-items-start">
                                      <input type="date" class="form-control" id="re_date2" placeholder="Add External provider" value="<?php echo $row['re_date2']; ?>" name="re_date2">
                                    </div>
                                  </div>
                      ...
                      <section class="case-area mt-2">
                        ...
                        <div class="row justify-content-start align-items-center mb-2">
                          <div class="col-lg-2 col-md-2 mb-2">
                            <label class="fw-semibold">Job Status:</label>
                          </div>
                          <div class="col-lg-6 col-md-4 mb-6">
                            <select id="inputsection" class="form-select" id="job_status" name="job_status" value="">
                              ...
                              <option value="Cancel" <?php
                                                      if ($row['job_status'] == "Cancel") {
                                                        echo "selected=selected";
                                                      } ?>>Cancel</option>
                              <option value="Progress" <?php
                                                        if ($row['job_status'] == "Progress") {
                                                          echo "selected=selected";
                                                        } ?>>Progress</option>
                          ...
                          <div class="col-lg-3 col-md-4 ">
                            <input type="date" class="form-control" id="re_date3" placeholder="Add External provider" value="<?php echo $row['re_date3']; ?>" name="re_date3">
                          </div>
                        </div>
                        <form class="source-item pt-2 px-0 px-sm-3">
                          ...
                          <div class="mb-2" data-repeater-list="group-a">
                            <div class="repeater-wrapper pt-2 pt-md-2" data-repeater-item="" ">
                              <div class=" d-flex rounded position-relative pe-0">
                              <div class="col-md-12 col-12 mb-md-0 mb-2">
                                <textarea class="form-control" rows="2" id="re_com" name="re_com"><?php echo $row['re_com']; ?></textarea>
                              </div>
                            </div>
                          </div>
                    </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-6"><a href="../admin/case_reprint.php?print_case=<?php echo $row['job_id']; ?>" class=" btn btn-secondary d-flex w-100 justify-content-center" name="preview">Preview</a></div>
          </div>
        </div>
      </div>
