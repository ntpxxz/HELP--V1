...
if (isset($_POST['insert'])) {
  ...
  if ($_POST['sts_b'] == "Approved") {
    $sts_r = "Borrowed";
  } else if ($_POST['sts_b'] == "Pending") {
    $sts_r = "Pending";
  } else if ($_POST['sts_b'] == "") {
    $sts_r = "Returned";
  }

  if ($_POST['sts_b'] == "Approved" && $sts_r == "Borrowed") {
    $dv_sts = "UAV";
  } else if ($_POST['sts_b'] == "Approved" && $sts_r == "Returned") {
    $dv_sts = "AV";
  } else if ($_POST['sts_b'] == "Pending" && $sts_r == "Pending") {
    $dv_sts = "AV";
  }
                      ...
                      <section class="case-area mt-0">
                        ...
                        <div class="row align-items-start justify-content-between text-start mb-2">
                          ...
                          <div class="col-lg-5 pe-2 mb-2">
                            <span class="fw-semibold py-2">Approve By:</span>&nbsp; <input type="text" class="form-control" id="app_b" name="app_b" value="<?php echo $_SESSION['name']; ?>&nbsp;<?php echo $_SESSION['lname']; ?>">
                          </div>
                          <div class="col-lg-4 col-md-4">
                            <label class="fw-semibold">Status:</label>
                            <select id="inputsection" class="form-select" id="sts_b" name="sts_b">
                          ...
                          <span class=" fw-semibold">On:</span>
                            <input type="date" class="form-control" id="app_bd" placeholder="Add External provider" value="<?php echo $row['app_bd']; ?>" name="app_bd">
                          </div>
                        </div>
                      </section>
                    </div>
                        ...
                        if ($row['app_r'] == null) {;
                          ...
                          <div class="row align-items-start justify-content-between text-start mb-2">
                            <form action="" method="POST" class="form-job">
                              ...
                              <div class="col-lg-3 col-md-2 align-items-start"">
                          <span class=" fw-semibold">On:</span>
                                <input type="date" class="form-control" id="app_d" placeholder="Add External provider" value="<?php echo $row['app_rd']; ?>" name="app_rd">
                              </div>
            ...
            <div class="card">
              <div class="col-xl-12">
                <div class="card-body"">
                  ...
                  <div class="col-md-4"><button href="'../admin/brr_reprint.php?print_brr={.$br_id.}'" name="preview" class="btn btn-outline-primary d-flex w-100 justify-content-center">Preview</button></div>
