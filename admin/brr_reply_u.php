...
if (isset($_POST['insert'])) {
  ...
  $name_r = $_POST['name_r'];
  $lname_r = $_POST['lname_r'];
  $mail_r = $_SESSION['user_mail'];
  $rt_d = $_POST['rt_d'];
  $sts_r = "Returned";
                      ...
                      <section class="case-area mt-0">
                        ...
                        <div class="row align-items-start justify-content-between text-start mb-2">
                          ...
                          <div class="col-lg-4 pe-2 mb-2">
                            <span class="fw-semibold py-2">Approve By:</span>&nbsp; <?php echo $_SESSION['name']; ?>
                          </div>
                ...
                <div class="card ">
                  <div class="card-body p-4">
                    ...
                    <section class="case-area mt-0">
                      ...
                      <div class="row align-items-start justify-content-between text-start mb-3">
                        <div class="col-4 pd-0">
                          <span class="fw-semibold py-2">Name</span>&nbsp; <input type="text" class="form-control" id="name_r" name="name_r" value="<?php echo $_SESSION['name']; ?>&nbsp;<?php echo $_SESSION['lname']; ?>">
                        </div>
                        <div class="col-4">
            ...
            <div class="row g-2">
              <div class="card">
                <div class="col-xl-12">
                  <div class="card-body"">
                    <div class=" row">
                    <div class="col-md-4"><button type="submit" onclick="window.location.href='../admin/brr_reprint.php?print_brr={.$print_brr.}'" class="btn btn-primary d-flex w-100 justify-content-center" name="insert">Save</button></div>
                    <div class="col-md-4"><button href=" brr_reprint.php?print_brr={.$br_id.}'" name="preview" class="btn btn-outline-primary d-flex w-100 justify-content-center">Preview</button></div>
