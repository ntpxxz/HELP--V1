                                   ...
                                   <div class="card">
                                       <div class="card-body">
                                           <section class="top-content  d-flex   align-items-center justify-content-center py-5">
                                               ...
                                               <div class="logo col-1 align-items-center mb-2 d-flex">
                                                   <img src="../assets/img/Riso-logo.jpg" alt="" class="img-fluid">
                                               </div>
                                               <div class="col-7 align-items-center text-start px-2">
                                                   <h3 class="fw-bold">Computer Service Request Form</h3>
                                               </div>
                                               <div class="col-4 align-items-center text-end">
                                                   <h5 class="fw-semibold">Req. No:<?php echo $row['job_id']; ?></h5>
                                               </div>
                                           </section>
