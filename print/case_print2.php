   <?php
    ...
    ?>
       ...
       <body>
           <input type="button" class="btn btn-primary" id="btn-generate" onclick="window.print()" value=" Print"></input>
           <div class="my-5 page" size="A4" id="pdf-content" class="pdf-content">
               <div class="p-5 ">
