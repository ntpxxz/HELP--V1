...
if (!isset($_SESSION)) {
    ...
    if (!$_SESSION['role'] = "user") {  //check session
        ...
        if (isset($_POST['insert'])) {
            ...
            $item_warrant = $_POST['item_warrant'];
            $sql = $insertdata->insert_items($item_reg, $item_cat, $item_type, $item_no, $item_name, $item_charger, $item_sec, $item_area, $item_detail, $item_sup, $item_warrant, $fileName);
            if ($sql) {
                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                            <img src="../upload/user_img/<?php echo $_SESSION['profile']; ?>" alt="Profile" class="rounded-circle img-thumbnail">
