                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3"><?php
                                      ...
                                      $sql = "SELECT COUNT(job_status) as success
                                                            FROM rith_jobcase WHERE job_status = 'Repair Complete'";
                                      $result = mysqli_query($connect, $sql);
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3"><?php
                                      ...
                                      $sql = "SELECT COUNT(job_status) as fixing
                                                            FROM rith_jobcase WHERE job_status = 'in Progress'";
                                      $result = mysqli_query($connect, $sql);
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3"><?php
                                      ...
                                      $sql = "SELECT COUNT(job_status) as cancel
                                                            FROM rith_jobcase WHERE job_status = 'Repair failed'";
                                      $result = mysqli_query($connect, $sql);
                      ...
                      <tr>
                        ...
                        ?>
                          ...
                          <td class="column8 align-items-center">
                            <?php
                            if ($row['job_status'] == 'Repair Complete') {
                              ...
                              echo '
                                <span class="badge rounded-pill text-bg-warning">Progessing</span>';
                            } ?>
                          </td>
