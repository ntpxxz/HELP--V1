...
if (isset($_POST['update'])) {
    ...
    $sql = $update_user->update_users($job_id, $job_date, $user_name, $user_lastname, $user_sec, $user_tel, $item_name, $item_area, $job_cat, $job_detail,  $job_charger, $job_status);
    if ($sql) {
                                ...
                                <div class="card">
                                    <div class="card-body center ">
                                        ...
                                        <div class="row g-3">
                                                ...
                                                <select id="inputCat" class="form-select" id="job_cat" name="job_cat">
                                                    ...
                                                    <option value="Request Install/Uninstall Program" <?php
                                                                                                        if ($row['job_cat'] == "Request Install/Uninstall Program") {
                                                                                                            echo "selected=selected";
                                                                                                        } ?>>Request Install/Uninstall Program</option>
                                            ...
                                            <a href="job_status.php" class="btn btn-secondary w-25" name="cancel">
                                                cancel
                                            </a>
                                        </div>
                                    <?php } ?>
