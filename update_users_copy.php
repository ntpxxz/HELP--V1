                                ...
                                <div class="card">
                                    <div class="card-body center ">
                                        ...
                                        <div class="mb align-items-center justify-content-center ">
                                            <button type="submit" class="btn btn-primary w-25 margin:5px" name="update">Update</button>&nbsp
                                            <a href=deleteuser.php?del_user=<?php echo $row['user_id']; ?>" class="btn btn-danger w-25" onclick="return checkDelete()"><i class=" bi bi-trash"></i></a>
                                            ...
                                            <a href="tbl_user.php" class="btn btn-secondary" name="cancel">
                                                cancel
                                            </a> &nbsp
