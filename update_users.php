...
if (isset($_POST['update'])) {
    ...
    $sql = $update_user->update_users($user_name, $user_lastname, $user_pass, $gender, $user_sec, $user_reg, $user_address, $user_mail, $user_tel, $user_id);
    if ($sql) {
                                    ...
                                    <div class="card-body center ">
                                        ...
                                        <div class="row g-5">
                                            <div class="col-lg-4 col-md-4">
                                                <label for="inputgender" class=" form-label text-align-center">Gender</label> <br>
                                        ...
                                        <hr>
                                        <div class="mb align-items-center justify-content-center ">
                                            <th>
                                                <div class="row g-3">
                                                    <div class="col-4"><button type="submit" class="btn btn-primary w-100 justify-content-center" name="update">Update</button></div>&nbsp
                                                    <div class="col"><a href=deleteuser.php?del_user=<?php echo $row['item_name']; ?> class=" btn btn-danger d-flex justify-content-center" < onclick="return checkDelete()"><i class=" bi bi-trash"></i></a></div>&nbsp
                                                    <div class="col"><a href="tbl_user.php" class="btn btn-secondary d-flex justify-content-center" name="cancel">cancel</a></div>
